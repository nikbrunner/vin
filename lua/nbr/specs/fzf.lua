...
M.keys = function()
    ...
    return {
        ...
        { "<S-CR>",           function() fzfLua.oldfiles({ cwd_only = true, prompt = "Recent Files (CWD): ", winopts = M.winopts.sm.no_preview }) end, desc = "Recent Files" },
        ...
        { "<leader>gc",       function() fzfLua.changes() end, desc = "[C]hanges" },
