...
M.keys = {
    ...
    { "<leader>ff", function() require("fzf-lua").files({ winopts = M.winopts.lg.flex }) end, desc = "[F]ind" },
    ...
    { "<leader>R", function() require("fzf-lua").oldfiles({ cwd_only = false, winopts = M.winopts.sm.no_preview }) end, desc = "Recent (Any)" },
    ...
    -- { "<leader>dD", function() require("fzf-lua").lsp_document_diagnostics({ winopts = M.winopts.lg.vertical }) end, desc = "[D]ocument (fzf)" },
    -- { "<leader>dW", function() require("fzf-lua").lsp_workspace_diagnostics({ winopts = M.winopts.lg.vertical }) end, desc = "[W]orkspace (fzf)" },
