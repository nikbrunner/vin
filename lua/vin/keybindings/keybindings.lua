...
keymap(
	"n",
	"<C-p>",
	"<cmd>lua require('vin.core.commands').fzf.find_files_without_preview()<CR>",
	opts
)
keymap(
	"n",
	"<C-e>",
	"<cmd>lua require('vin.core.commands').fzf.find_buffers()<CR>",
	opts
)
keymap(
	"n",
	"<C-_>",
	"<cmd>lua require('vin.core.commands').fzf.find_in_file()<CR>",
	opts
)
...
keymap(
	"n",
	"<C-g>",
	"<cmd>lua require('vin.core.commands').fzf.find_modified_files_with_preview()<CR>",
	opts
)
keymap(
	"n",
